...
try{
window._psClientMainLoadedAt=Date.now();

if(localStorage.getItem('ps_debug_connect')==='1'){
console.debug('[PS][debug] client-main module loaded at',window._psClientMainLoadedAt);
}
}catch(_unused){}
...
confirm=function confirm(message){var _opts$cancelButton,_this12=this;var opts=arguments.length>1&&arguments[1]!==undefined?arguments[1]:{};
...
{var _opts$cancelButton2,_this13=this;var defaultValue=arguments.length>1&&arguments[1]!==undefined?arguments[1]:'';var opts=arguments.length>2&&arguments[2]!==undefined?arguments[2]:{};
